...
if(~isIF)
    if(min == 60)
        result = [9, 10, 11.15, 14.15, 15, 21, 22, 23, 23.599, 0, 1, 2, 2.3];
    elseif(min == 30)
        result = [9, 9.30, 10, 10.45, 11.15, 13.45, 14.15, 14.45, 15];
        result = [result, 21 : 0.3 : 21.599];
        result = [result, 22 : 0.3 : 22.599];
        result = [result, 23 : 0.3 : 23.599];
    ...
    elseif(min == 1440)
        ...
        result = [result,14 : min/100 : 14.599, 15.00];
        result = [result,21 : min/100 : 21.599];
        result = [result,22 : min/100 : 22.599];
        result = [result,23 : min/100 : 23.599];
